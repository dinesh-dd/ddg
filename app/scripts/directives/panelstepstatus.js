...
angular.module('gePantApp')
    ...
    .directive("panelStepStatus", function() {
        return {
            ...
            link: function(a, b) {
                angular.element(b).addClass("status-icon"), a.classes = "", a.$watch("[stepData.open,stepData.validated,stepData.validate()]", function() {
    ...
    .directive("round", function() {
        return {
            ...
            template: '<div class="round">\n  '+
                      '<div class="round-format"><img src="images/format-round.png" alt="" /></div>\n '+ 
